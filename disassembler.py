...
class Disassembler():
    ...
    def getInstruction(self, address: int) -> bytes:
        ...
        self.__next_address = address + len(instruction.bytes)
        return instruction.bytes

    def getNextInstruction(self) -> bytes:
        return self.getInstruction(self.__next_address)
